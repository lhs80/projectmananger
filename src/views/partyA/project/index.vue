    ...
    <section>
        <aside>
            ...
            <el-row class="h4 text-secondgrey mt2 search-wrapper">
                <el-col :span="6">
                    <label>预计开工：</label>
                    <el-date-picker v-model="search.startTime" type="date" placeholder="请输入预计开工时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-col>
                <el-col :span="6">
                    <label>至：</label>
                    <el-date-picker v-model="search.endTime" type="date" placeholder="请输入预计开工时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-col>
                <el-col :span="6">
                    <label>预计完工：</label>
                    <el-date-picker v-model="search.overStartTime" type="date" placeholder="请输入预计开工时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-col>
                <el-col :span="6">
                    <label>至：</label>
                    <el-date-picker v-model="search.overEndTime" type="date" placeholder="请输入预计开工时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
                </el-col>
            </el-row>
        </aside>
        ...
        <aside class="mt4">
            <el-table border :data="list" style="width: 100%">
                ...
                <el-table-column label="操作" width="80" align="center">
                    <template slot-scope="scope">
                        <router-link tag="a" :to="'/project/detail/'+scope.row.projectId" class="text-primary">详情</router-link>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
